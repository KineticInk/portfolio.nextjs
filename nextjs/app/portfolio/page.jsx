            ...
            <div className={styles.contentSection}>
                ...
                <div className={styles.pictures}>
                    <div className={styles.picture}>
                        <Image className={styles.flick} src={BBShower1} alt="bbshower" fill style={{ objectFit: 'contain' }} />
                    </div>
                    <div className={styles.picture}>
                        <Image className={styles.flick} src={BBShowercollage} alt="bbshower collage" fill style={{ objectFit: 'contain' }} />
                    </div>
                    <div className={styles.picture}>
                        <Image className={styles.flick} src={BBShowerhands} alt="bbshower hands" fill style={{ objectFit: 'contain' }} />
                    </div>
                    <div className={styles.picture}>
                        <Image className={styles.flick} src={Smokeforest} alt="smoke forest" fill style={{ objectFit: 'contain' }} />
                    </div>
                    <div className={styles.picture}>
                        <Image className={styles.flick} src={Forestpain} alt="forest" fill style={{ objectFit: 'contain' }} />
                    </div>
